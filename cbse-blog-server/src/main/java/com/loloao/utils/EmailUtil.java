...
public class EmailUtil implements EmailService
{
    ...
    public boolean sendHtmlMail(String to, String subject, String content) {
        ...
        try {
            ...
            //日志信息
            //logger.info("邮件已经发送。");
            System.out.println("EmailUtils ==> email sent successfully");
            return true;
        } catch (Exception e) {
            //logger.error("发送邮件时发生异常！", e);
            System.out.println("EmailUtils ==> email sent failed >" + e.getMessage());
            return false;
        }
    }
    ...
    public boolean sendAttachmentsMail(String to, String subject, String content, String filePath) {
        ...
        try {
            ...
            //logger.error("发送邮件时发生异常！", e);
            System.out.println("EmailUtils ==> email sent failed");
            return false;
        }
    }
}